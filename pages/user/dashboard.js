...
const Dashboard = () => {
  ...
  const findPeople = async () => {
    try {
      ...
      console.log("Failed getting people");
    }
  };
  ...
  const postSubmit = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        toast.success("Post created", { autoClose: true });
        newsFeed();
        setContent("");
        setImage("");
      }
  ...
  const addComment = async (e) => {
    e.preventDefault();
    // console.log(" Add comment to current post", currentPost._id);
    try {
      ...
      console.log("Error commenting", er);
    }
  };
